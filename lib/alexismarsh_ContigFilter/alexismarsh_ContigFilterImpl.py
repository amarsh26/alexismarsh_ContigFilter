...
class alexismarsh_ContigFilter:
    '''
    Module Name:
...
This sample module contains one small method that filters contigs.
    ...
    def run_alexismarsh_ContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_alexismarsh_ContigFilter

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_alexismarsh_ContigFilter function. Params=' + pformat(params))
        ...
        #END run_alexismarsh_ContigFilter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_alexismarsh_ContigFilter return value ' +
